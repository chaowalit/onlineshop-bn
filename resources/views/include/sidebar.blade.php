  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=" treeview">
          <a href="#">
            <i class="ion ion-bag"></i> <span>All Products</span> 
          </a>
        </li>

        <li class=" treeview">
          <a href="#">
            <i class="fa fa-shopping-cart"></i> <span>New Orders</span> 
          </a>
        </li>

        <li class=" treeview">
          <a href="#">
            <i class="ion ion-person"></i> <span>All Members</span> 
          </a>
        </li>

        <li class=" treeview">
          <a href="#">
            <i class="ion ion-pie-graph"></i> <span>All Category</span> 
          </a>
        </li>
